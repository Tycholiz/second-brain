...
- take 2 explanations that explain the same phenomenon: 1 simple and 1 complex. the first have 3 moving parts (3 variables) and the second has 30. if there was 99% confidence that each variable was trustworthy, then the first explanation would have only a 3% chance of being wrong, while the second would have a 26% chance
