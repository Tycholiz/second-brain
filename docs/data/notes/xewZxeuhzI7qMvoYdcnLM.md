...
The reason it gets colder the higher you go is because molecules are more spread out, due to the decreasing atmospheric pressure.
- When there are fewer molecules in a given space, the air is less capable of absorbing and retaining heat, resulting in cooler temperatures experienced at higher elevations
...
What makes a bad explanation bad is not if it testable or not, but if the explanation can be varied in response to it being disproven. 
-ex. The Ancient Greek explanation for the seasons tells us that every year Persephone becomes sad and that coldness brings on winter. 6 months later, she becomes happy again, bringing the warmth of summer. This explanation is bad because if it was pointed out that “the hemispheres experience seasons at opposite times”, then the explanation could simply be altered. The story could then go “in northern hemisphere winter, she leaves and goes to the southern hemisphere, bringing her warmth with her”. On the other hand, the actual explanation for seasons (tilt of the earth) is good, because not only does it account for the differing seasons in each hemisphere, but if that observation was found not to be true, then their proponents of the theory would have nowhere to go. There would be no way to alter the explanation to fit the observation of differing seasons in each hemisphere 