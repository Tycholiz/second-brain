...
To hear what a compressor truly does, stick it on a drum bus (start with just kick and snare). Set a decent threshold (4:1) and play with the attack and release. Notice what it does to the sound of the drums.
...
- You might decide to compress one sound moreso to give it more relative presence, or you may decide to compress everything to increase overall presence of the mix
...
- prevent a softer sound from being lost in the mix (especially if that sound varies in volume)
...
- [10 Hour Compression course (Dylan Pines)](https://www.youtube.com/watch?v=ksJRgK3viMc)
