...
## How does a positive adaptive trait manifest incrementally over time?
Consider the moth that can camouflage its open wing-set against a tree trunk. How did the descendent line of these moths evolve from having no camouflage to a moth with almost perfect camouflage? Well, it didn’t happen in one generation. When moths started developing slight dark tinges in their wings, it led to a higher rate of survival against predators who were far away. While up close, the predator would be able to just as easily spot the moth with dark tinges in its wings, that small tinge offered the slight advantage that reduced its visible range from 100 yards to 90 yards. With every successive mutation that gives the moth an even darker wing-set, their increasing incremental success leads to higher survival rates for their genes. This process continues until we eventually arrive at our optimally painted wing-set, giving the moth a distinct survival advantage compared to other prey.
