...
Imaginary numbers and real numbers are the two starting sets that when combined make up complex numbers (ie. complex numbers are the union set of all real numbers and all imaginary numbers.
